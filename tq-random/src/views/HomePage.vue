    ...
    <section class="bg-gray-100 py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Join thousands of users who trust TQ Random for their randomization
          needs
        </p>
        <button
          class="bg-blue-600 text-white hover:bg-blue-700 font-semibold py-3 px-8 rounded-lg transition-colors duration-200"
        >
          Start Now
        </button>
      </div>
